...
python3 runHHH6bPNetAK4.py --option 4 -o /isilon/data/users/mstamenk/hhh-6b-producer-run3/CMSSW_13_3_0/src/PhysicsTools/NanoAODTools/condor/${VERSION} --year ${YEAR} --run-signal -n 2 --jobprocessor run_processor_lxplus.sh --condordesc 2 --tmpoutdir "\$TMPDIR" --post
